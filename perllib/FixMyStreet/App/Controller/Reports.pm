...
sub stash_report_filter_status : Private {
    ...
    my $body_user = $c->user_exists and $c->stash->{body} and $c->user->belongs_to_body($c->stash->{body}->id);
    my $staff_user = $c->user_exists and ($c->user->is_superuser or $body_user);
