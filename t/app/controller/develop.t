...
subtest 'dev email index page' => sub {
    ...
    $mech->content_contains('<li><a href="login">login</a></li>');
    $mech->content_contains('<li><a href="questionnaire?problem=' . $problem->id  . '">questionnaire</a></li>');
    $mech->content_contains('<li><a href="update-confirm?update=' . $update->id . '">update-confirm</a></li>');
};
